...
and 	Logical and, but lower priority thatn && # puts "Hello" and "Goodbye"
...
ensure	Run this code whether an expression happens or not. # begin ensure end
...
undef	Removes a function definition from a class # undef X
